...
public class RentController {
    ...
    public ResponseEntity<RentDto> createRent(@RequestBody RentDto rentDto) throws ReaderNotFoundException, CopyNotFoundException {
    ...
    public ResponseEntity<Object> returnRent(@PathVariable Long rentId) throws RentNotFoundException, BookAlreadyReturned {
